...
public class SSOClientUtil {
	...
	public static String CLIENT_HOST_URL = "http://localhost:8080/sso-clientA";// 当前客户端地址
	 ...
	 * http://localhost:8080/sso-server/checkLogin?redirectUrl=http://localhost:8080/sso-client/index.jsp
	 * 通过Response跳转到指定的地址
	 * 
	 * @param request
	 * @param response
